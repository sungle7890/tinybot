...
| 2026-09-05 | Power board changed **motor driver and power board (Pololu 3543) → power distribution board (Pololu 3541) + TB6612** | The R4 regulates 6–24 V on VIN itself, so motor driver and power board (Pololu 3543)'s 2 A regulator is redundant. power distribution board (Pololu 3541) handles power only, keeping the TB6612 and leaving firmware and pin map untouched. Saves $15 |
